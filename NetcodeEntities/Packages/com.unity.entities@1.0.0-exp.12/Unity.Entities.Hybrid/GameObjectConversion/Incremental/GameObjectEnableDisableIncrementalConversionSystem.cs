...
namespace Unity.Entities
{
    ...
    partial class GameObjectEnableDisableIncrementalConversionSystem : SystemBase
    {
        ...
        protected override void OnCreate()
        {
            ...
            AddDisabledGameObjectsFromScene(World.GetExistingSystemManaged<GameObjectConversionMappingSystem>());
        }
        ...
        protected override void OnUpdate()
        {
            ...
            using (var activeChildren = new NativeList<int>(Allocator.TempJob))
            {
                ...
                _incremental.AddConversionRequest(activeChildren.AsArray());
            }
